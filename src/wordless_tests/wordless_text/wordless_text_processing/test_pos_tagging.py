...
def test_pos_tag(lang, pos_tagger):
    ...
    if lang == 'zho_cn':
        ...
        assert tokens_tagged == [('Het', 'LID|bep|stan|evon'), ('Nederlands', 'N|eigen|ev|basis|onz|stan'), ('is', 'WW|pv|tgw|ev'), ('een', 'LID|onbep|stan|agr'), ('West-Germaanse', 'ADJ|prenom|basis|met-e|stan'), ('taal', 'N|soort|ev|basis|zijd|stan'), ('en', 'VG|neven'), ('de', 'LID|bep|stan|rest'), ('moedertaal', 'N|soort|ev|basis|zijd|stan'), ('van', 'VZ|init'), ('de', 'LID|bep|stan|rest'), ('meeste', 'VNW|onbep|grad|stan|prenom|met-e|agr|sup'), ('inwoners', 'N|soort|mv|basis'), ('van', 'VZ|init'), ('Nederland', 'N|eigen|ev|basis|onz|stan'), (',', 'LET'), ('België', 'N|eigen|ev|basis|onz|stan'), ('en', 'VG|neven'), ('Suriname', 'N|eigen|ev|basis|onz|stan'), ('.', 'LET')]
